...
4. **Bass follows the roots**: derive it from the same progression with `chord(prog).rootNotes(2)`. The beat where the chord changes must play the root, and the rhythm follows the kick.
