...
You can learn more about both of these approaches in the pages [Synths](learn/synths.md) and [Samples](learn/samples.md).

# Combining notes and sounds

In both of the above cases, we are no longer directly controlling the `note`/`freq` of the sound heard via `s`, as we were in the [Notes](workshop/first-notes.md) page.
...
Let's now take a step back and think about the Strudel [Code](learn/code.md) we've been hearing so far.

---
Source: https://strudel.cc/learn/sounds/ (AGPL-3.0, Strudel contributors)
