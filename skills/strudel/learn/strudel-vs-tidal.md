...
While Strudel also has a way of [communicating with Superdirt](learn/input-output.md),
...
You can find a [list of available effects here](learn/effects.md).

### Sampler

Strudel's sampler supports [a subset](learn/samples.md) of Superdirt's sampler.
...
---
Source: https://strudel.cc/learn/strudel-vs-tidal/ (AGPL-3.0, Strudel contributors)
