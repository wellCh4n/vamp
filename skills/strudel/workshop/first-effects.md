...
Let us now take a look at some of Tidal's typical [pattern effects](workshop/pattern-effects.md).

---
Source: https://strudel.cc/workshop/first-effects/ (AGPL-3.0, Strudel contributors)
